class Game {
    ...
    constructor(ctx) {
        ...
        this._bgoundAudio = document.getElementById('bground');
        this._bgoundAudio.volume = 0.4;
        this._painAudio = document.getElementById('pain');
    }

    start() {
        this._drawStartLife();
        this._warrior.setName();
        this._bgoundAudio.play();
